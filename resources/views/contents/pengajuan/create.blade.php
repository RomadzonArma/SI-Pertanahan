        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="add-form" action="{{ route('pengajuan.store') }}" enctype="multipart/form-data" method="post"
                        autocomplete="off">
                        @csrf
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-10">
                                <textarea name="alamat" id="alamat" rows="3" class="form-control" placeholder="Masukkan alamat">{{ $user->alamat ?? '' }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            <div class="col-md-2">
                        ...
                        <div class="form-group row mt-3">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" placeholder="Masukkan pekerjaan"
                                    id="pekerjaan"name="pekerjaan" value="{{ $user->pekerjaan ?? '' }}">
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            <div class="col-md-2">
                        ...
                        <div class="form-group row mt-2">
                            ...
                            <div class="col-md-10">
                                <textarea name="lokasi" id="lokasi" rows="3" class="form-control" placeholder="Masukkan lokasi"></textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-3">
                            <div class="col-md-2">
...
@push('scripts')
    <script src="{{ asset('js/page/pengajuan/create.js?q=' . Str::random(5)) }}"></script>
@endpush
