...
<div class="modal-body">
    ...
    <div class="row mt-4">
        <div class="col-sm-12">
            <form id="form-ajukan-kadin" action="{{ route('pengajuan.send_ajukan_kadin') }}" method="post"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="status" id="status" class="form-control select2" required>
                            ...
                            <option value="1200">Verifikasi ditolak Kepala Dinas</option>
                            <option value="1300">Verifikasi diterima Kepala Dinas</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="fieldisian" style="display: none">
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <label for="text" class="col-form-label">Cetak Peta Situasi KRK</label>
                        </div>
                        <div class="col-sm-6">
                            <div class="btn-group">
                                <a class="btn btn-primary btn-sm" target="_blank" href="javascript:void(0);"><i
...
<div class="modal-footer">
    <button type="submit" form="form-ajukan-kadin" class="btn btn-primary">Verifikasi</button>
...
<script>
    ...
    $('#form-ajukan-kadin').submit(function(e) {
        e.preventDefault();
