...
<div class="modal-body">
    ...
    <div class="row mt-4">
        <div class="col-sm-12">
            <form id="form-ajukan-subkoor" action="{{ route('pengajuan.send_ajukan_subkoor') }}" method="post"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="status" id="status" class="form-control select2" required>
                            ...
                            <option value="800">Verifikasi ditolak Subkoor</option>
                            <option value="900">Verifikasi diterima Subkoor</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
...
<div class="modal-footer">
    <button type="submit" form="form-ajukan-subkoor" class="btn btn-primary">Verifikasi</button>
...
<script>
    ...
    $('#form-ajukan-subkoor').submit(function(e) {
        e.preventDefault();
        ...
        post.done(function(respon) {
            if (respon.status == true) {
                ...
                $('#modal_ajukansubkoor').modal('hide');
                location.reload();
            } else {
                swal.close();
